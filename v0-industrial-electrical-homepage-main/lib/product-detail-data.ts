...
این محصول مناسب برای پروژه‌های صنعتی، تأمین تجهیزات کارخانه، و خریداران عمده می‌باشد. تیم فنی صنعت الکتریک آماده ارائه مشاوره تخصصی برای انتخاب مناسب‌ترین کلید برای پروژه شما است.`,
  documents: [
  ...
  faqs: [
    {
      ...
      answer:
        "بله، تمامی محصولات اشنایدر الکتریک عرضه شده در صنعت الکتریک دارای ضمانت اصالت کالا هستند و مستقیماً از نمایندگی‌های رسمی تأمین می‌شوند. هولوگرام و شماره سریال محصول قابل استعلام از سایت اشنایدر است.",
    },
    {
