    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2">
        {inStock ? (
          <>
            ...
            <span className="text-sm text-muted-foreground">
              ({safeStockCount > 0 ? safeStockCount.toLocaleString("en-US") : "قابل بررسی"} عدد)
            </span>
          </>
        ) : (
          <>
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          <Button asChild variant="outline" size="lg" className="h-12 w-full gap-2 rounded-xl">
      ...
      <div className="grid grid-cols-3 gap-1 border-t border-border pt-4 sm:gap-3">
        <div className="flex flex-col items-center text-center gap-2 p-2 sm:p-3">
